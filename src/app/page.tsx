    ...
    <>
      <nav className="bg-primary text-primary-foreground p-4 fixed top-0 left-0 right-0 z-50">
        <div className="container mx-auto flex justify-between items-center">
          <a href="#hero" className="font-bold text-xl hover:text-white">$MASHI</a>
      ...
      {isMenuOpen && (
        <div className="fixed top-16 left-0 right-0 bg-primary text-primary-foreground p-4 z-40 md:hidden">
          <div className="flex flex-col space-y-2">
            <a href="#about" className="hover:text-white" onClick={() => setIsMenuOpen(false)}>About</a>
            <a href="#buy" className="hover:text-white" onClick={() => setIsMenuOpen(false)}>Buy</a>
            <a href="#community" className="hover:text-white" onClick={() => setIsMenuOpen(false)}>Community</a>
          </div>
        </div>
      )}

      <main className="flex flex-col items-center relative pt-16">
        <div id="hero" className="w-full bg-cover bg-center flex flex-col items-center justify-center hero-bg py-24">
